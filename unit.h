...
signals:
   ...
   private:
    ...
    void init(const QSize& screenSize = QSize(640,480), const QSize &designedForSize = QSize(640,480), const qreal ratioMin = 0.0f, const qreal ratioMax = 99.0f, const bool roundUp = false);
